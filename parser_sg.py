...
class sgpr_args():
    ...
    # 解析yaml中的各种参数
    def load(self,config_file): # Load configuration
        config_args=yaml.load(open(os.path.abspath(config_file)), Loader=yaml.FullLoader)
        #arch
        ...
        self.continue_train=config_args['common']['continue_train']
