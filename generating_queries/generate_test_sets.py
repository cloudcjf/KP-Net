...
def construct_query_and_database_sets(BASE_DIR, base_path, runs_folder, folders, pointcloud_fols, filename, p, output_name):
    database_trees = []
    test_trees = []
    for folder in folders:
        ...
        df_locations = pd.read_csv(os.path.join(
            BASE_DIR,base_path,runs_folder,folder,filename),sep=',')
...
print(folders)
construct_query_and_database_sets(BASE_DIR, base_path, runs_folder, folders, "/pointcloud_20m/",
...
print(folders)
construct_query_and_database_sets(BASE_DIR, base_path, runs_folder, folders, "/pointcloud_25m_25/",
